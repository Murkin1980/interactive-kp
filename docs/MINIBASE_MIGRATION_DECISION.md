...
Список и создание КП также переведены на `/api/proposals` и MiniBase. Коллекции
клиентов и КП партиционированы по manager ID. Автонумерация пока имеет известное
ограничение конкурентной записи и не готова к production cutover без атомарного
примитива MiniBase.
